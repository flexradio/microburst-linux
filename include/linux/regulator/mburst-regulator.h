...
#ifndef REGULATOR_MBURST
#define REGULATOR_MBURST
 ...
 * @gpio_arr_mask:	Mask for GPIO lines if the voltage control GPIOggg
 ...
 */
struct mburst_vr_platform_data {
	const	char			*name;
	u32				pmic_vout;
