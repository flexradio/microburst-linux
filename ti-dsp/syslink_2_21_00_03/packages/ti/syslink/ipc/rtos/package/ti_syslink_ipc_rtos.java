...
public class ti_syslink_ipc_rtos
{
    ...
    void Syslink$$TYPES()
    {
        ...
        po.addFld("terminateEventId", Proto.Elm.newCNum("(xdc_UInt32)"), 30L, "wh");
        po.addFld("terminateEventLineId", Proto.Elm.newCNum("(xdc_UInt16)"), 0L, "wh");
    ...
    void Syslink$$SINGLETONS()
    {
        ...
        atmap.setElem("", "./Syslink.xdt");
        atmap.seal("length");
        vo.bind("TEMPLATE$", "./Syslink.xdt");
        pkgV.bind("Syslink", vo);
