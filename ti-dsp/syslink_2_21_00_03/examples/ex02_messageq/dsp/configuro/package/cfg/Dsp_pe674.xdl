...
-l"/src/flex/microburst-linux/ti-dsp/syslink_2_21_00_03/examples/ex02_messageq/dsp/configuro/package/cfg/Dsp_pe674.oe674"
...
MEMORY
{
    ...
    SR_1 (RWX) : org = 0x8e010000, len = 0x20000
...
SECTIONS
{
    ...
    ti.sdo.ipc.SharedRegion_1:  { . += 0x20000;} run > 0x8e010000, type = NOLOAD
